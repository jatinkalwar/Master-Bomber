cd $HOME/ighack/core                                                                                   
update(){                                                                                                             
if wget --spider https://raw.githubusercontent.com/jatinkalwar/toolupdater/ms.v.1 2>/dev/null; then
...
echo
echo
echo -e "\e[92m             MASTER-BOMBER LATEST \e[91mNO PATCH AVAILABLE FOR NOW...!\e[92m\e[0m"
echo -e "\e[96m                ╔═══════════════════════════════════╗\e[0m"
echo -e "\e[96m                ║       \e[93mMaster-Bomber\e[96m Uptodate\e[93m V1.2\e[96m         ║\e[0m"
...
option(){
if [ -f "$HOME/spamx/server/patch.txt" ];then
$dbox
else
echo
fi
